...
// Include file  sendmail
require PUBLICPATH . DIRECTORY_SEPARATOR . 'customer/Mail/sendmail.php';

// Include file  function send
require PUBLICPATH . DIRECTORY_SEPARATOR . 'customer/Mail/check.php';
